...
function debugTestFour() {
   ...
   const debugTestFourInputOne = document.getElementById('debugTestFourInputOne').valueAsNumber
   const debugTestFourInputTwo = document.getElementById('debugTestFourInputTwo').valueAsNumber
